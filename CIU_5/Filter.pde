public class Filter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Show Rental Bicycle");

        jCheckBox2.setText("Show Returned Bicycle");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {  
        dayFrom = (!jTextField1.getText().equals("") ? Integer.parseInt(jTextField1.getText()) : -1);
        monthFrom = (!jTextField2.getText().equals("") ? Integer.parseInt(jTextField2.getText()) : -1);
        yearFrom = (!jTextField3.getText().equals("") ? Integer.parseInt(jTextField3.getText()) : -1);
